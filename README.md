...
<div align = "left" style ="margin: 20px; font-size: 16px;">
    <p><strong>Name:</strong> Adimulam Rahul Sai </p>
    <p><strong>Email ID:</strong> adimulamrahulsai@gmail.com </p>
    <p><strong>College Name:</strong> Vignan's Lara Institute of Technology & Science </p>
    <p><strong>Branch/Specialization :</strong> Master Of Computer Applications(MCA) </p>
    <p><strong>College ID:</strong> 24FE1F0001 </p>
</div>
...
<div align="left" style="margin: 20px; font-size: 16px;">
    <p><strong>Course Opted:</strong> SQL & PowerBI </p>
    <p><strong>Instructor Name:</strong> Sravan Nemana </p>
</div>
<div align="left" style="margin: 20px; font-size: 16px;">
    <p><strong>Duration:</strong> July 2025 to December 2025 </p>
...
<p><strong>Trainer Name:Sravan Nemana</p>
<p><strong>Trainer Email ID:</strong>nemsaaai@gmail.com </p>
...
<!-- Project 1 -->
<h3 id="project1">Project 1: WORLD HAPPINESS REPORT </h3>
<p>
  This project involved designing and developing a basic functional module using the core concepts taught in the course.
  It focused on understanding requirements, creating structured code, and implementing key features.
</p>
<p>
  <a href="https://github.com/Rahul158-jpg/World-happiness-Report/blob/main/project.pdf" target="_blank"><strong>→ View Full Project Report</strong></a>
</p>
